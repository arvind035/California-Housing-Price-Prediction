...
from HousePricePrediction.logger import logging, get_log_file_name
from HousePricePrediction.exception import HousePriceException
from threading import Thread
from typing import List

from multiprocessing import Process
from HousePricePrediction.entity.artifact_entity import ModelPusherArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from HousePricePrediction.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
from HousePricePrediction.entity.config_entity import DataIngestionConfig, ModelEvaluationConfig
from HousePricePrediction.component.data_ingestion import DataIngestion
from HousePricePrediction.component.data_validation import DataValidation
from HousePricePrediction.component.data_transformation import DataTransformation
from HousePricePrediction.component.model_trainer import ModelTrainer
from HousePricePrediction.component.model_evaluation import ModelEvaluation
from HousePricePrediction.component.model_pusher import ModelPusher
import os, sys
from collections import namedtuple
from datetime import datetime
import pandas as pd
from HousePricePrediction.constant import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        '''
        This is function for run pipeline
        '''
        try:
    ...
    def save_experiment(self):
        '''
        This is function for save experiments
        '''
        try:
    ...
    def get_experiments_status(cls, limit: int = 5) -> pd.DataFrame:
        '''
        This is function for get experiments status
        '''
        try:
            if os.path.exists(Pipeline.experiment_file_path):
