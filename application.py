...
import pip
from HousePricePrediction.util.util import read_yaml_file, write_yaml_file
...
from HousePricePrediction.constant import CONFIG_DIR, get_current_time_stamp
from HousePricePrediction.pipeline.pipeline import Pipeline
from HousePricePrediction.entity.housing_predictor import HousingPredictor, HousingData
...
from HousePricePrediction.logger import get_log_dataframe
...
@app.route('/artifact', defaults={'req_path': 'HousePricePrediction'})
@app.route('/artifact/<path:req_path>')
def render_artifact_dir(req_path):
    os.makedirs("HousePricePrediction", exist_ok=True)
